...
export default class All extends Component {
    ...
    componentDidMount(){
        fetch('https://cnodejs.org/api/v1/topics?tab=all&mdrender=true&page=1',{method:'GET'})
    ...
    click=(num)=>{
        fetch('https://cnodejs.org/api/v1/topics?tab=all&mdrender=true&page='+num,{method:'GET'})
        .then((res)=>res.json()).then((res)=>{
            this.setState({
                data:res.data
            })
