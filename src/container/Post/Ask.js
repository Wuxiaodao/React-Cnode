...
export default class Ask extends Component {
    ...
    componentDidMount(){
        ...
        fetch('https://cnodejs.org/api/v1/topics?tab=ask&mdrender=true&page=1',{method:'GET'})
        .then((res)=>res.json())
        .then((res)=>{
            this.setState({
                data:res.data
    ...
    click=(num)=>{
        fetch('https://cnodejs.org/api/v1/topics?tab=ask&mdrender=true&page='+num,{method:'GET'})
        .then((res)=>res.json())
        .then((res)=>{
            this.setState({
                data:res.data
