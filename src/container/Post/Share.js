...
export default class Share extends Component {
    ...
    componentDidMount(){
        fetch('https://cnodejs.org/api/v1/topics?tab=share&mdrender=true&page=1',{method:'GET'})
        .then((res)=>res.json())
        .then((res)=>{
            this.setState({
                data:res.data
    ...
    click=(num)=>{
        fetch('https://cnodejs.org/api/v1/topics?tab=share&mdrender=true&page='+num,{method:'GET'})
        .then((res)=>res.json())
        .then((res)=>{
            this.setState({
                data:res.data
