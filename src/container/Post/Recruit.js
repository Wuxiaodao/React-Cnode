...
export default class Recruit extends Component {
    ...
    componentDidMount(){
        fetch('https://cnodejs.org/api/v1/topics?tab=job&mdrender=true&page=1',{method:'GET'})
        .then((res)=>res.json())
        .then((res)=>{
            this.setState({
                data:res.data
    ...
    click=(num)=>{
        fetch('https://cnodejs.org/api/v1/topics?tab=job&mdrender=true&page='+num,{method:'GET'})
        .then((res)=>res.json())
        .then((res)=>{
            this.setState({
                data:res.data
